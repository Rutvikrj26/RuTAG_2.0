    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=datetime.datetime(2020, 6, 3, 1, 13, 39, 230317), verbose_name='Creation Date')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('newsletter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='article.newsletter')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
