# Generated by Django 3.1a1 on 2020-06-01 09:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', ckeditor.fields.RichTextField(verbose_name='Enter the Project proposal/Abstract over here')),
                ('Project_poster', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Add Photo of product')),
                ('Project_report', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Add Report of project in pdf Format')),
